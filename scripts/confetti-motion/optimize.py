...
def write_typescript(
    ...
    with path.open("w") as handle:
        ...
        handle.write(
            "// Generated by the scored CV-to-physics optimizer. Do not hand-edit.\n"
        )
        handle.write("export const recordingCannonParticleSystem = ")
...
def main() -> None:
    ...
    payload = write_typescript(args.output, best_fits, best_config, prior)
